...
//            测试的数据
    ...
    // 标签列表允许设置任何类型的数据，而不仅仅是String。并且标签显示的内容
...
//            }
     ...
     * @param labels
     */
    public LabelsView setLabels(List<String> labels) {
     ...
     * @param <T>
     */
    public <T> LabelsView setLabels(List<T> labels, LabelTextProvider<T> provider) {
        //清空原有的标签
        innerClearAllSelect();
        removeAllViews();
        mLabels.clear();
    ...
    private LabelsView setLabelSelect(TextView label, boolean isSelect) {
     ...
     * @param positions
     */
    public LabelsView setSelects(List<Integer> positions) {
        if (positions != null) {
     ...
     * @param positions
     */
    public LabelsView setSelects(int... positions) {
        if (mSelectType != SelectType.NONE) {
     ...
     * @param positions
     */
    public LabelsView setCompulsorys(List<Integer> positions) {
     ...
     * @param positions
     */
    public LabelsView setCompulsorys(int... positions) {
        if (mSelectType == SelectType.MULTI && positions != null) {
     ...
     */
    public LabelsView clearCompulsorys() {
        if (mSelectType == SelectType.MULTI && !mCompulsorys.isEmpty()) {
            mCompulsorys.clear();
            //必选项发生改变，就要恢复到初始状态。
            innerClearAllSelect();
     ...
     * @param resId
     */
    public LabelsView setLabelBackgroundResource(int resId) {
     ...
     * @param color
     */
    public LabelsView setLabelBackgroundColor(int color) {
     ...
     * @param drawable
     */
    public LabelsView setLabelBackgroundDrawable(Drawable drawable) {
        mLabelBg = drawable;
        int count = getChildCount();
        for (int i = 0; i < count; i++) {
            TextView label = (TextView) getChildAt(i);
     ...
     * @param bottom
     */
    public LabelsView setLabelTextPadding(int left, int top, int right, int bottom) {
     ...
     * @param size
     */
    public LabelsView setLabelTextSize(float size) {
        if (mTextSize != size) {
            mTextSize = size;
            int count = getChildCount();
            for (int i = 0; i < count; i++) {
     ...
     * @param color
     */
    public LabelsView setLabelTextColor(int color) {
     ...
     * @param color
     */
    public LabelsView setLabelTextColor(ColorStateList color) {
        mTextColor = color;
        int count = getChildCount();
        for (int i = 0; i < count; i++) {
            TextView label = (TextView) getChildAt(i);
     ...
     * @param gravity
     */
    public LabelsView setLabelGravity(int gravity) {
     ...
     * 设置行间隔
     */
    public LabelsView setLineMargin(int margin) {
     ...
     * 设置标签的间隔
     */
    public LabelsView setWordMargin(int margin) {
     ...
     * @param selectType
     */
    public LabelsView setSelectType(SelectType selectType) {
     ...
     * @param maxSelect
     */
    public LabelsView setMaxSelect(int maxSelect) {
     ...
     * @param minSelect
     */
    public LabelsView setMinSelect(int minSelect) {
     ...
     * @param maxLines
     */
    public LabelsView setMaxLines(int maxLines) {
     ...
     * @param indicator
     */
    public LabelsView setIndicator(boolean indicator) {
     ...
     * @param isSingleLine
     */
    public LabelsView setSingleLine(boolean isSingleLine) {
     ...
     * @param l
     */
    public LabelsView setOnLabelClickListener(OnLabelClickListener l) {
     ...
     * @param l
     */
    public LabelsView setOnLabelSelectChangeListener(OnLabelSelectChangeListener l) {
     ...
     * @param intercept
     */
    public LabelsView setOnSelectChangeIntercept(OnSelectChangeIntercept intercept) {
